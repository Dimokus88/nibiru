...
# Nibiru validator node on Akash Network
  
# Нода валидатора сети Nibiru, развертка в Akash Network.
...
| [Discord Nibiru](https://discord.gg/sgPw8ZYfpQ) | [Explorer Nibiru](https://nibiru.explorers.guru/) | [Site Nibiru](https://nibiru.fi/) | [Twitter Nibiru](https://twitter.com/NibiruChain) |
|:--:|:--:|:--:|:--:|
  
<div align="center">
  
[English version](https://github.com/Dimokus88/nibiru/tree/main#english-version) | [Русская версия](https://github.com/Dimokus88/nibiru/tree/main#%D1%80%D1%83%D1%81%D1%81%D0%BA%D0%B0%D1%8F-%D0%B2%D0%B5%D1%80%D1%81%D0%B8%D1%8F) 
...
# English version
### Deployment of the Nibiru node.

Deploy [deploy.yml](https://github.com/Dimokus88/nibiru/blob/main/deploy.yml) **Nibiru** nodes with **Cloudmos (Akashlytics)** ( [use instructions here](https://github.com/Dimokus88/guides/blob/main/Akashlytics/EN-guide.md) ) by setting the values ​​in the corresponding `deploy.yml` variables:
...
You can delegate the remaining tokens to yourself, but leave 1,000,000 unibi to pay for transaction gas:
...
[Back to top](https://github.com/Dimokus88/nibiru/blob/main/README.md#nibiru-validator-node-on-akash-network)

**Thank you for using Akash Network!**

___
# Русская версия
### Развертка ноды Nibiru.

Разверните [deploy.yml](https://github.com/Dimokus88/nibiru/blob/main/deploy.yml) ноды **Nibiru** с помощью **Cloudmos (Akashlytics)**  ([инструкция по использованию здесь](https://github.com/Dimokus88/guides/blob/main/Akashlytics/RU-guide.md)) установив значения в соответствующих переменных  `deploy.yml`: 
...
Можете делегировать на себя оставшиеся токены, но оставьте 1 000 000 unibi для оплаты газа транзакций:
...
[К началу](https://github.com/Dimokus88/nibiru/blob/main/README.md#nibiru-validator-node-on-akash-network)
